...
static char *gg_cp_to_utf8(char *b) {
	unsigned char *buf = (unsigned char *) b;
	char *newbuf;
	int newlen = 0;
	int i, j;
	...
	for (i = 0; buf[i]; i++) {
		unsigned short znak = (buf[i] < 0x80) ? buf[i] : table_cp1250[buf[i]-0x80];
...
static char *gg_utf8_to_cp(char *b) {
	unsigned char *buf = (unsigned char *) b;
...
static char *gg_utf8_to_latin2(char *b)
{
	unsigned char *buf = (unsigned char *) b;
...
static char *gg_latin2_to_utf8(char *b)
{
	unsigned char *buf = (unsigned char *) b;
	char *newbuf;
	int newlen = 0;
