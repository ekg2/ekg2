/* REPLACEMENT CHARACTER http://www.fileformat.info/info/unicode/char/fffd/index.htm */
#define RECHAR 0xfffd   /* "\357\277\275 */ 
// #define RECHAR '?'

static const unsigned short table_cp1250[] = {
	0x20ac, RECHAR, 0x201a, RECHAR, 0x201e, 0x2026, 0x2020, 0x2021, 	/* 0x80 -      */
	RECHAR, 0x2030, 0x0160, 0x2039, 0x015a, 0x0164, 0x017d, 0x0179,		/*      - 0x8F */
	RECHAR, 0x2018, 0x2019, 0x201c, 0x201d, 0x2022, 0x2013, 0x2014,		/* 0x90 -      */ 
	RECHAR, 0x2122, 0x0161, 0x203a, 0x015b, 0x0165, 0x017e, 0x017a,		/*      - 0x9F */
...
static const unsigned short table_iso_8859_2[] = {
	RECHAR, RECHAR, RECHAR, RECHAR, RECHAR, RECHAR, RECHAR, RECHAR,		/* 0x80 -      */
	RECHAR, RECHAR, RECHAR, RECHAR, RECHAR, RECHAR, RECHAR, RECHAR,		/*      - 0x8F */
	RECHAR, RECHAR, RECHAR, RECHAR, RECHAR, RECHAR, RECHAR, RECHAR,		/* 0x90 -      */
	RECHAR, RECHAR, RECHAR, RECHAR, RECHAR, RECHAR, RECHAR, RECHAR,		/*      - 0x9F */
