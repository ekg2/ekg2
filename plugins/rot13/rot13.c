...
EXPORT int rot13_plugin_init(int prio) {
	...
	new_guery_connect(&rot13_plugin, "set_vars_default", rot13_setvar_default, NULL);
	new_guery_connect(&rot13_plugin, "message_encrypt", message_parse, (void *) 1);
	new_guery_connect(&rot13_plugin, "message_decrypt", message_parse, (void *) 0);
